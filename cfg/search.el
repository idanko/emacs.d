...
(global-anzu-mode +1)
(evil-global-set-key 'normal (kbd "<leader> \\ r") #'anzu-query-replace)
(evil-global-set-key 'normal (kbd "<leader> \\ x") #'anzu-query-replace-regexp)

;;; RG.
;; See how to use: https://www.youtube.com/watch?v=OcR-Ke2CiPo
(straight-use-package 'rg)
(evil-global-set-key 'normal (kbd "<leader> \\ g") #'rg)
(evil-global-set-key 'normal (kbd "<leader> \\ !") #'wgrep-save-all-buffers)
...
(evil-define-key '(normal visual) 'global-map (kbd "<leader> \\ \\") #'id/counsel-project-rg)
(evil-define-key '(normal visual) 'global-map (kbd "<leader> \\ |") #'id/counsel-rg)
